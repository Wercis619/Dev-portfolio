...
public class Snowman : MonoBehaviour
{
    ...
    [SerializeField] private GameObject snowBulletPrefab;
    ...
    private void Shoot()
    {
        var spawnedBullet = Instantiate(snowBulletPrefab, transform.position, Quaternion.identity);
